...
public class PlayerCamera : MonoBehaviour
{
    ...
    void UpdateDistance()
    {
        m_Distance = Mathf.Clamp(m_Distance - Input.GetAxis("Horizontal2") * ScrollModifier, MinimumDistance, MaximumDistance);
    }
    ...
    void UpdateRotation()
    {
        ...
        {
            transform.Rotate(0, Input.GetAxis("Fire1") * TurnModifier, 0);
        }
